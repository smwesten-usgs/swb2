...
c                   i=1,nsoil; j=1,nseq(i); l=1,nlay(i,j)
      ...
      dimension avrf(500000,12),avfd(500000,12),avir(500000,12),
     1   avro(500000,12),av1ae(500000,12),av2ae(500000,12),
     2   av3ae(500000,12),av4ae(500000,12),av1rc(500000,12),
     3   av2rc(500000,12),av3rc(500000,12),av4rc(500000,12),
     4   avdirect(500000,12),avpnet(500000,12),avcanint(500000,12),
     5   avrfadj(500000,12),avseptic(500000,12),avstrmdrn(500000,12)
...
!      data target_polys/60515,63533,277684,336981,339872,342876,353812,345298/
     ...
     3   perv,cprate,isdrain,canfrac,tfrac,cerf
      ...
      open(7,file='output/errorcheck.out')
...
c.....read in yearly recharge output code (1-yearly output,0-no yearly output)(30 years max)
      read(10,*)irechyrly
...
c    pan coefficient is not temporally variable
     ...
     5   totrc4a(12),totseptic(12),totsd(12),yrlyrech(500000,30)
      dimension idemsup(20),supirr(20),rmltirr(20),effirr(20),
     1          irrday(20,31),nirrdays(20,12),irrsug(50000)
      dimension stormdrain(500000),ceint(6)
...
C  888      888     .8"888.      888   888           `888. .8'
C  888      888    .8' `888.     888   888            `888.8'
C  888      888   .88ooo8888.    888   888             `888'
C  888     d88'  .8'     `888.   888   888       o      888
C o888bood8P'   o88o     o8888o o888o o888ooooood8     o88
C
C oooooooooo.  ooooo     ooo oooooooooo.     .oooooo.    oooooooooooo ooooooooooooo  .oooooo..o
C `888'   `Y8b `888'     `8' `888'   `Y8b   d8P'  `Y8b   `888'     `8 8'   888   `8 d8P'    `Y8
C  888     888  888       8   888      888 888            888              888      Y88bo.
C  888oooo888'  888       8   888      888 888            888oooo8         888       `"Y8888o.
C  888    `88b  888       8   888      888 888     ooooo  888    "         888           `"Y88b
C  888    .88P  `88.    .8'   888     d88' `88.    .88'   888       o      888      oo     .d8P
C o888bood8P'     `YbodP'    o888bood8P'    `Y8bood8P'   o888ooooood8     o888o     8""88888P'
C
...
c...........determine mean daily potential et
     ...
     1             ilu(ip).eq.ilusug(3))then
                ...
                pe=pc*pan
                pancoef(ilu(ip),m) = pc   ! kludge to force pancoef to have a value - SMW
            else                          ! when the landuse is sugar...
...
c...........update totals over entire area
            daily_aet2 = ae + aepaved * (1-perv(ip))
            totae2(m)=totae2(m)+ae+aepaved*(1-perv(ip))
            totrc2(m)=totrc2(m)+rc
            rechann=rechann+rc

C           variable added so that we can preserve and print out the daily recharge
C           generated by means of the FAO-56 method (SMW)
            daily_rc2 = rc
...
C oooooooooo.   ooooo     ooo ooo        ooooo ooooooooo.
C `888'   `Y8b  `888'     `8' `88.       .888' `888   `Y88.
C  888      888  888       8   888b     d'888   888   .d88'
C  888      888  888       8   8 Y88. .P  888   888ooo88P'
C  888      888  888       8   8  `888'   888   888
C  888     d88'  `88.    .8'   8    Y     888   888
C o888bood8P'      `YbodP'    o8o        o8
C
C oooooo     oooo       .o.       ooooooooo.   ooooo       .o.       oooooooooo.  ooooo        oooooooooooo  .oooooo..o
C  `888.     .8'       .888.      `888   `Y88. `888'      .888.      `888'   `Y8b `888'        `888'     `8 d8P'    `Y8
C   `888.   .8'       .8"888.      888   .d88'  888      .8"888.      888     888  888          888         Y88bo.
C    `888. .8'       .8' `888.     888ooo88P'   888     .8' `888.     888oooo888'  888          888oooo8     `"Y8888o.
C     `888.8'       .88ooo8888.    888`88b.     888    .88ooo8888.    888    `88b  888          888    "         `"Y88b
...
c.....write yearly recharge during first year of last simulation if water body
        if(ilu(ip).eq.iluwater.and.i.eq.1.and.isim.eq.nsim)then
            if(ip.eq.1)write(43,4200)
            do j=1,nyrs
                yrlyrech(ip,j)=wbrc
            end do
            write(43,4300)ip,(yrlyrech(ip,l),l=1,nyrs)
...
800   continue
 ...
 4200 format('Poly_ID,Rech1,Rech2,Rech3,Rech4,Rech5,Rech6,Rech7,Rech8,',
     1       'Rech9,Rech10,Rech11,Rech12,Rech13,Rech14,Rech15,Rech16,',
     2       'Rech17,Rech18,Rech19,Rech20,Rech21,Rech22,Rech23,Rech24,',
     3       'Rech25,Rech26,Rech27,Rech28,Rech29,Rech30,')
 4300 format(i7,',',30(f8.3,','))
