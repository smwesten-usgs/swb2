...
gfortran -g -O2 -static -static-libgfortran -static-libgcc -fno-align-commons -finit-local-zero -fdiagnostics-color=always -ffixed-line-length-none -fbacktrace -fcheck=all -Warray-bounds kiss_random_number_generator.o HI_WB_3_9.f -o HI_WB_3_9__smw.exe
