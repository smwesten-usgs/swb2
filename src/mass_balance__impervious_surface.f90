...
contains
   ...
   subroutine calculate_impervious_surface_mass_balance( surface_storage,            & 
                                                         actual_et,                  &   
    ...
    surface_storage = surface_storage + ( rainfall + snowmelt ) * cells%impervious_fraction

    actual_ET = actual_ET + min( cells%reference_ET0, cells%surface_storage) * cells%impervious_fraction
      
    surface_storage = surface_storage - min( reference_ET0, surface_storage)

    surface_storage_excess = max( 0.0_c_float, surface_storage - surface_storage_max ) * cells%impervious_fraction
