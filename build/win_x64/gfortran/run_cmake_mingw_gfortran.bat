...
set CMAKE_Fortran_FLAGS_RELEASE="-O3 -mtune=core2 -march=core2 -flto -ffree-line-length-none -static -static-libgcc -static-libgfortran -DCURL_STATICLIB -ffpe-summary=none -fopenmp"
